...
Squelette Flask avec routes :
  GET  /           → accueil (statut API)
  POST /diagnose   → reçoit une analyse et la sauvegarde en base
  GET  /history    → retourne les derniers diagnostics
"""
